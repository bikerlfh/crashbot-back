    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_min_bets_allowed_in_bank', models.IntegerField(default=300, help_text='Number of minimum bets allowed in bank')),
                ...
                ('max_second_multiplier', models.FloatField(default=0.0, help_text='Maximum second multiplier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_home_bet_game', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='details', to='predictions.modelhomebetgame')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('condition_on', models.CharField(choices=[('every_win', 'EVERY_WIN'), ('every_loss', 'EVERY_LOSS'), ('streak_wins', 'STREAK_WINS'), ('streak_losses', 'STREAK_LOSSES'), ('streak_n_multiplier_less_than', 'STREAK_N_MULTIPLIER_LESS_THAN'), ('streak_n_multiplier_greater_than', 'STREAK_N_MULTIPLIER_GREATER_THAN'), ('profit_greater_than', 'PROFIT_GREATER_THAN'), ('profit_less_than', 'PROFIT_LESS_THAN')], default='every_win', max_length=64)),
